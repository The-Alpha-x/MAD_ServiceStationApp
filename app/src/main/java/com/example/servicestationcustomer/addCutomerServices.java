        ...
        btnAddData.setOnClickListener(
                ...
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (sUsername.matches("")) {
                            Toast.makeText(MainActivity.this, "Please enter vehcile Number", Toast.LENGTH_SHORT).show();
                            return;}
                        ...
                        if (sUsername.matches("")) {
                            Toast.makeText(MainActivity.this, "Please enter service", Toast.LENGTH_SHORT).show();
                            return;}
